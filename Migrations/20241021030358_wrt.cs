...
{
    public partial class wrt : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActiveName = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_activeIngredients", x => x.ActiveIngredientID);
                    table.ForeignKey(
                        name: "FK_activeIngredients_active_ActiveName",
                        column: x => x.ActiveName,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_anallergies_activeIngredients_ActiveId",
                        column: x => x.ActiveId,
                        principalTable: "activeIngredients",
                        principalColumn: "ActiveIngredientID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_anallergies_patients_PatientId",
                        column: x => x.PatientId,
                        principalTable: "patients",
                        principalColumn: "PatientID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_bookingNewPatients_patients_PatientID",
                        column: x => x.PatientID,
                        principalTable: "patients",
                        principalColumn: "PatientID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_bookingNewPatients_Surgeons_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CurrentMedications_medications_MedicationId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PatientVitalsID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Time = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Reading2 = table.Column<double>(type: "float", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_patientVitals_bookingNewPatients_BookingNewPatientID",
                        column: x => x.BookingNewPatientID,
                        principalTable: "bookingNewPatients",
                        principalColumn: "BookingNewPatientID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MedicationPrescriptionID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PharmacyMedicationID = table.Column<int>(type: "int", nullable: false),
                    Prescription = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_medicationPrescriptions_prescriptions_PrescriptionsPrescriptionID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ranges_CurrentMedications_CurrentMedicationID",
                        column: x => x.CurrentMedicationID,
                        principalTable: "CurrentMedications",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AdmissionId = table.Column<int>(type: "int", nullable: false),
                    NurseNotes = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    Date = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Discharges_admission_AdmissionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_activeIngredients_ActiveName",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_admission_BookingNewPatientID",
                table: "admission",
                column: "BookingNewPatientID");

            migrationBuilder.CreateIndex(
                name: "IX_admission_NurseId",
                table: "admission",
                column: "NurseId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_bookingNewPatients_PatientID",
                table: "bookingNewPatients",
                column: "PatientID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CurrentMedications_MedicationId",
            ...
            migrationBuilder.CreateIndex(
                ...
                column: "ChronicMedicationID",
                unique: true,
                filter: "[ChronicMedicationID] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_medicationPrescriptions_PrescriptionsPrescriptionID",
                table: "medicationPrescriptions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_patientVitals_BookingNewPatientID",
                table: "patientVitals",
                column: "BookingNewPatientID");
