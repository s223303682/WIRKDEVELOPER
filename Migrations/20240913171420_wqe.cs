        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PatientProvince = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Address1 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Address2 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    City = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Surbub = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    BedID = table.Column<int>(type: "int", nullable: false),
                    ConditionName = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CurrentMedicationID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CurrentMedicationName = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NurseResponsible = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OperationTheatreID = table.Column<int>(type: "int", nullable: false),
                    TreatmentCodeID = table.Column<int>(type: "int", nullable: false),
                    Anaesthesiologist = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Ward = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Bed = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_bookingNewPatients_treatmentCodes_TreatmentCodeID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_addm_anallergies_AllergiesID",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_addm_conditions_ConditionID",
                        column: x => x.ConditionID,
                        principalTable: "conditions",
                        principalColumn: "ConditionID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_addm_CurrentMedication_CurrentMedicationID",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_addm_treatmentCodes_TreatmentID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ancurrentmedication_medications_MedicationID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Time = table.Column<DateTime>(type: "datetime2", nullable: false),
                    OperationTheatreID = table.Column<int>(type: "int", nullable: false),
                    Anaestesiologist = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TreatmentCodeIDs = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_bookings", x => x.BookingID);
                    table.ForeignKey(
                        name: "FK_bookings_addm_AddmID",
                        column: x => x.AddmID,
                        principalTable: "addm",
                        principalColumn: "AddmID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_pharmacyMedications_ordercreate_OrderCreateID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Quantity = table.Column<int>(type: "int", nullable: false),
                    Instructions = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    orderAnOrderID = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ordermedication", x => x.OrderMedicationID);
                    table.ForeignKey(
                        name: "FK_ordermedication_order_orderAnOrderID",
                        column: x => x.orderAnOrderID,
                        principalTable: "order",
                        principalColumn: "AnOrderID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_addm_ConditionID",
                table: "addm",
                column: "ConditionID");

            migrationBuilder.CreateIndex(
                name: "IX_addm_CurrentMedicationID",
                table: "addm",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ancurrentmedication_MedicationID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_bookingNewPatients_TreatmentCodeID",
                table: "bookingNewPatients",
                column: "TreatmentCodeID");

            migrationBuilder.CreateIndex(
                name: "IX_bookings_AddmID",
                table: "bookings",
                column: "AddmID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_order_PharmacyMedicationID",
                table: "order",
                column: "PharmacyMedicationID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ordermedication_orderAnOrderID",
                table: "ordermedication",
                column: "orderAnOrderID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_pharmacyMedications_OrderCreateID",
                table: "pharmacyMedications",
                column: "OrderCreateID");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_order_pharmacyMedications_PharmacyMedicationID",
                table: "order",
                column: "PharmacyMedicationID",
                principalTable: "pharmacyMedications",
                principalColumn: "PharmacyMedicationID",
